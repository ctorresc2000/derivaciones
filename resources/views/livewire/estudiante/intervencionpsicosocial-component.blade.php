            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_auto] gap-4 mb-6 items-end">
                <div>
                    <flux:select label="Motivo Intervención" wire:model="motivo_seleccionado_id">
                        <option value="">Selecciona un motivo de Intervención</option>
                ...
                <div>
                    <flux:select label="Tipo de Intervención" wire:model="tipo_seleccionado_id">
                        <option value="">Selecciona un tipo de intervención</option>
                ...
                <div class="rounded-lg border border-slate-200 dark:border-zinc-700 overflow-hidden bg-white dark:bg-zinc-800 shadow-sm">
                    <table class="w-full text-sm text-left text-slate-600 dark:text-zinc-300">
                        <thead class="text-xs text-slate-700 uppercase bg-slate-100 dark:bg-zinc-900/80 dark:text-zinc-400">
                            <tr>
                                <th scope="col" class="px-6 py-3 w-5/12">Motivo de Intervención</th>
                                <th scope="col" class="px-6 py-3 w-5/12 border-l border-slate-200 dark:border-zinc-700">Tipo de Intervencion</th>
