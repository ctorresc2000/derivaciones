<div class="w-full py-10">
    ...
    <h1 class="text-3xl mt-4 mb-4">Tipos de Intervención</h1>
    <hr class="mb-3">

    <div class="flex justify-end px-6">
        <flux:button wire:click="$set('abrirModal', true)">
            <i class="fa-solid fa-circle-plus"></i><span class="ml-3">Nueva Tipo de Intervención</span>
        </flux:button>
    </div>
    ...
    @livewire('tablas.tipointervencion-table')
    ...
    <flux:modal wire:model="abrirModal" :dismissible="false" :closable="false" class="md:w-1/2" max-width="7xl">
        ...
        <flux:card>
            ...
            <flux:text class="text-gray-500 mb-4">
                Registra un nuevo tipo de Intervención
            </flux:text>
